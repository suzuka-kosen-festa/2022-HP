...
const Backgorund = tw.div`flex flex-col items-center justify-center w-full h-[calc(200vw / 3)] md:h-screen bg-center bg-cover`;
...
const HeroSection: React.FC<HeroSectionProperties> = ({ date, title, ...rest }) => (
  <HeroSectionContainer aria-label={"第57回鈴鹿高専祭"} {...rest}>
    ...
    >
      ...
      <img src={"/statics/logo.webp"} alt={"第57回鈴鹿高専祭、Re:ROADのロゴ"} css={tw`w-[calc(8200vw / 189)]`} />
