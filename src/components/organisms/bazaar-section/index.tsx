...
const BazaarSection: FC<BazaarSectionProperties> = ({ attentionTitle, attentions, buttonText, description, title, ...rest }) => (
  <BazaarSectionContainer aria-label="bazaar" {...rest}>
    <Heading css={tw`mb-4 sm:mb-6`} colorKey="purple">{title}</Heading>
    ...
    <Link to="/bazaar">
      <Button colorKey="purple" as="a" role="button">{buttonText}</Button>
    </Link>
