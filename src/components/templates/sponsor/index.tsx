...
const Sponsor: FC<SponsorProperties> = ({ sponsors }) => (
  <Main aria-label="Sponsor page">
    <Title css={tw`mb-5.5 sm:mb-14`} colorKey="red">Sponsor</Title>
    <SponsorBox>
      <h2 css={tw`font-zen font-bold text-text text-base mb-8 sm:(text-2xl mb-20)`}>第57回鈴鹿高専祭を開催するにあたり、支援してくださった企業様のお名前を以下に記載させていただきます。</h2>
      ...
      <Link to="/">
        <Button textStyles={tw`text-white`} colorKey="red" as="a" role="button">トップページに戻る</Button>
      </Link>
    </SponsorBox>
  </Main>
);
